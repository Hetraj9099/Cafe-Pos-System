    ...
    >
      <div className="aspect-[4/3] overflow-hidden bg-slate-100">
        {product.image_url ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(135deg,#ede9fe_0%,#e2e8f0_100%)] text-xs font-medium uppercase tracking-[0.24em] text-slate-500">
            {product.category}
          </div>
        )}
      </div>
      <div className="flex flex-1 flex-col justify-between gap-3 p-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="rounded-lg bg-slate-100 px-2.5 py-1 text-xs font-medium text-slate-600 transition group-hover:bg-slate-800 group-hover:text-white">
            Add
          </span>
        </div>
      </div>
